    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Consumer <Crudprovider>(
          builder: (BuildContext context,  State, Widget? child) { return 
          Column(
            ...
            children: [
              ...
              Column(
                children: [
                   InkWell(
                      onTap: () {
                       //FirebaseFirestore.instance.collection("Users").add({"email":emailController.text,"password":passwordController.text,"phonenumber":phonenumberController.text});
                       State.addData(Usermodel(
                        email: emailController.text,password: passwordController.text,phonenumber: phonenumberController.text,
                       ));
                      },
                      child: Center(
                        child: Container(
